	...
	<div className="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
		<Head>
			...
			<meta
				...
				content="zorbz are generated by the Zora API marketplace events. visualized with image from the zorb collection."
			/>
			<meta property="og:image" content="ipfs://QmQTCVZk7nJHk6HjjiBTvXBGLivFiPwjb47aZfvxwZTVxc" />
			...
			<meta
				...
				content="zorbz are generated by the Zora API marketplace events. visualized with image from the zorb collection."
			/>
			<meta name="twitter:image:src" content="ipfs://QmQTCVZk7nJHk6HjjiBTvXBGLivFiPwjb47aZfvxwZTVxc" />
		</Head>
